  ...
  return (
    <section className="w-full overflow-hidden">
      <Layout className="pt-14">
        <div className="grid grid-cols-2 xl:pt-3 2xl:pt-3 md:grid-cols-1 md:gap-5 md:pt-3 xs:gap-5 lg:gap-5">
          ...
          <div className="mt-8">
            <div className="px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-900 lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
